...
/*
	...
	A C/C++ include file, implementing drawing primitives.
*/
...
extern void SetLineDash(int black, int white);
...
/*	Draws a rectangle with top left corner at (x1, y1) and bottom
	...
	Output: DR(x1,y1,x2,y2) */

extern void DrawRect(double x1, double y1, double x2, double y2); 
...
extern void DrawDot(double x, double y, int r);
...
extern void DrawChar(char c, double x, double y);
...
extern void DrawName(char *n, double x, double y);
